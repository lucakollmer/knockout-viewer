...
function genericHashResidues(r: number): Point {
  return genericHashResiduesSeed(r, 0);
}
...
const MATRIX_PROFILES: readonly Profile[] = [
  ...
  {
    id: 'opposite-fifth',
    label: 'opposite pair with one-fifth middle coefficient',
    residues: (r) => oppositeSeedResidues(r, 1, 5),
  },
  {
    id: 'opposite-two-fifths',
    label: 'opposite pair with two-fifths middle coefficient',
    residues: (r) => oppositeSeedResidues(r, 2, 5),
  },
  {
    id: 'repeated-nonopposite',
    label: 'repeated non-opposite coefficients',
    residues: repeatedNonOppositeResidues,
  },
  {
    id: 'generic-hash-2',
    label: 'deterministic generic coefficients seed 2',
    residues: (r) => genericHashResiduesSeed(r, 1),
  },
  {
    id: 'generic-hash-3',
    label: 'deterministic generic coefficients seed 3',
    residues: (r) => genericHashResiduesSeed(r, 2),
  },
];
...
export default function AsetsFrontierBenchmarkPage() {
    ...
    try {
      ...
      const payload = {
        ...
        benchmark: {
          ...
          harness_version: 5,
          benchmark_kind: 'adaptive-r-frontier+extended-coefficient-symmetry-matrix',
          ...
          coefficient_matrix: {
            ...
            classification: 'extended fixed-r matrix preserving the original controls and adding deterministic opposite-pair, repeated-nonopposite, and generic coefficient samples',
  ...
  return (
    <main style={{ maxWidth: 1180, margin: '0 auto', padding: 24, fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ marginBottom: 4 }}>Asets adaptive frontier + extended coefficient-symmetry benchmark</h1>
      <p style={{ marginTop: 0, color: '#666' }}>
        Scope: {benchmarkScope}. The historical r-frontier and extended fixed-r coefficient matrix can be run independently or together.
      </p>
